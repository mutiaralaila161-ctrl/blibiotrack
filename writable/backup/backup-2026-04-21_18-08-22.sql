...
INSERT INTO `buku` VALUES (1,'9786022916628','Laskar Pelangi',1,2,1,2005,10,10,'Novel terkenal Indonesia','1776792958_95f318fab4178692f3a9.avif'),(2,'9786020682563','Harry Potter',1,3,1,2000,5,5,'Berapa usia Harry ketika masuk Hogwarts?\r\nSiapa yang memberikan PETA PERAMPOK, dan berapa ukuran GOLDEN SNITCH?\r\n\r\nTemukan semua jawabannya dan banyak info lain tentang Harry Potter!\r\nBersiaplah bertemu naga, bermain Quidditch, juga mengetahui berbagai kata kunci rahasia dan fakta di balik tongkat sihir dari Ollivanders.\r\n','1776793354_e616ccc8f5e107a67ac6.avif'),(3,'9786023763672','Belajar Coding',3,5,4,2024,7,7,'Revolusi industri sudah merambah seluruh aspek kehidupan. Untuk menghadapi tantangan ini, tentu kita sebagai generasi milenial tidak bisa hanya duduk dan belajar melalui teks dan buku. Itu, sudah menjadi bahan pokok, yang kemudian harus diimbangi dengan pemahaman teknologi masa kini. Hal ini dilakukan tentu untuk membuat data pribadi sebagai manusia unggul yang tidak tergilas oleh zaman.','1776793543_a4b9cc85b61b8ac556cd.avif');
...
INSERT INTO `buku_rak` VALUES (4,1,1),(3,2,2),(5,3,3);
...
INSERT INTO `kategori` VALUES (1,'Fiksi'),(2,'Non-Fiksi'),(3,'Teknologi'),(4,'Sejarah'),(5,'Pendidikan');
...
INSERT INTO `penerbit` VALUES (1,'Gramedia','Jakarta'),(2,'Erlangga','Jakarta'),(3,'Mizan','Bandung'),(4,'Deepublish','Yogyakarta');
...
INSERT INTO `penulis` VALUES (1,'Tere Liye'),(2,'Andrea Hirata'),(3,'J.K. Rowling'),(4,'Albert Einstein'),(5,'Budi Santoso');
...
INSERT INTO `rak` VALUES (1,'Rak A','Lantai 1'),(2,'Rak B','Lantai 1'),(3,'Rak C','Lantai 2');
...
INSERT INTO `users` VALUES (1,'Mutiara Laila','mutiaralaila3006@gmail.com','mutilaila','$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S','admin','1776792254_f5eff466f0ab618978e0.jpg','aktif','2026-04-10 15:31:04'),(2,'Yuvin Mahameru','yuvinmahameru@gmail.com','yuvinmeru','$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S','petugas','1776792271_efb598da9e425b779ca3.jpg','aktif','2026-04-10 15:32:38'),(3,'Clara Seraphina','claraseraphina@gmail.com','clarasera','$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S','anggota','1776792282_02542819ad9bc2a24940.jpg','aktif','2026-04-10 15:35:01');
...
-- Dump completed on 2026-04-22  1:08:23
