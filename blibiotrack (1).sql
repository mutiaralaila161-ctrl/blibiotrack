...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Apr 2026 pada 15.32
...
INSERT INTO `anggota` (`id_anggota`, `id_user`, `nis`, `alamat`, `no_hp`, `tanggal_daftar`) VALUES
...
(49, '9786349651967', 'Laut Pasang 1994 (New Version)', 20, 27, 8, '2026', 10, 10, 'Peristiwa yang menghancurkan seluruh kota dalam waktu singkat.\r\n\r\nTujuh raga menyedihkan menjadi saksi bagaimana gilanya gelombang pasang malam itu. Malam terakhir penuh bintang, seindah senyuman ibu enam tahun silam.\r\n\r\n\"Apta! Esa! Pegang tangan Mas yang kenceng!\"\r\n\r\nKalimat itu menjadi kalimat terakhir Khalid sebagai usahanya yang ternyata sia-sia. Semuanya terjadi begitu cepat, air laut naik kepermukaan lebih ganas dari dugaannya dan mampu memisahkan genggaman tangan mereka satu sama lain tanpa belas kasihan.', '1777342217_a02a8e6a3438a6c9f378.avif');
...
(18, 51, 6000.00, 'belum_bayar', NULL, NULL),
(19, 52, 2000.00, 'belum_bayar', NULL, NULL);
...
(98, 80, 46, NULL, 'belum'),
(99, 80, 47, NULL, 'belum'),
(118, 90, 49, NULL, 'belum'),
(119, 91, 48, NULL, 'belum'),
(120, 91, 49, NULL, 'belum'),
(121, 92, 47, NULL, 'belum'),
(122, 92, 49, NULL, 'belum');
...
(80, 7, 3, '2026-04-26', '2026-04-29', '', NULL),
(90, 9, 3, '2026-04-24', '2026-04-27', '', NULL),
(91, 7, 3, '2026-04-22', '2026-04-25', '', NULL),
(92, 9, 3, '2026-04-22', '2026-04-25', 'dipinjam', NULL);
...
(50, 80, '2026-04-28', 0.00),
(51, 91, '2026-04-28', 0.00),
(52, 90, '2026-04-28', 0.00);
...
(5, 91, 'denda', 6000.00, 'lunas', '2026-04-28 04:50:06'),
(6, 90, 'denda', 2000.00, 'lunas', '2026-04-28 05:08:33');
...
INSERT INTO `users` (`id_user`, `nama`, `email`, `username`, `password`, `role`, `foto`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Mutiara Laila', 'mutiaralaila@gmail.com', 'mutiaralaila', '$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S', 'admin', '1777380069_7c07c4a9f68f00f7ff0c.jpg', 'aktif', '2026-04-10 15:31:04', '2026-04-28 12:50:13'),
(3, 'Clara Seraphina', 'claraseraphina@gmail.com', 'clarasera', '$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S', 'anggota', '1777046572_6ed63eb1197fce76819e.jpg', 'aktif', '2026-04-10 15:35:01', NULL),
(5, 'Winter Clarie', 'winterclarie@gmail.com', 'imwinter', '$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S', 'anggota', '1777084308_877774600cd8579bb2ed.jpg', 'aktif', '2026-04-21 18:35:51', NULL),
(11, 'Gheara Yuna Celestia', 'ghearayuna@gmail.com', 'gheara', '$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S', 'petugas', '1777102512_c5be9e0f64f0fa6c91f9.jpg', 'aktif', '2026-04-21 18:36:28', NULL);
...
--
ALTER TABLE `denda`
  MODIFY `id_denda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `detail_peminjaman`
--
ALTER TABLE `detail_peminjaman`
  MODIFY `id_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `pengembalian`
  MODIFY `id_pengembalian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `penulis`
  MODIFY `id_penulis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
ALTER TABLE `buku`
  ...
  ADD CONSTRAINT `fk_buku_penulis` FOREIGN KEY (`id_penulis`) REFERENCES `penulis` (`id_penulis`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `fk_transaksi_peminjaman` FOREIGN KEY (`id_peminjaman`) REFERENCES `peminjaman` (`id_peminjaman`) ON DELETE CASCADE ON UPDATE CASCADE,
